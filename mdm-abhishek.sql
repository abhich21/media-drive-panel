...
CREATE TABLE `cars` (
  ...
  `car_code` varchar(10) DEFAULT NULL,
...
INSERT INTO `cars` (`id`, `event_id`, `car_code`, `engine_number`, `name`, `model`, `registration_number`, `color`, `image_url`, `initial_km`, `initial_fuel`, `status`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 1, 'A1', 'ENG001234', 'Tata Punch', 'Creative 1.2', NULL, 'White', NULL, 0.0, 100, 'standby', 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(2, 1, 'A2', 'ENG001235', 'Tata Punch', 'Creative 1.2', NULL, 'Red', NULL, 0.0, 100, 'standby', 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(3, 1, 'B1', 'ENG002001', 'Tata Nexon', 'EV Max', NULL, 'Blue', NULL, 0.0, 100, 'standby', 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(4, 1, 'B2', 'ENG002002', 'Tata Nexon', 'EV Max', NULL, 'White', NULL, 0.0, 100, 'standby', 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(5, 1, 'C1', 'ENG003001', 'Tata Harrier', 'XZ+', NULL, 'Black', NULL, 0.0, 100, 'standby', 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(6, 1, 'C2', 'ENG003002', 'Tata Harrier', 'XZ+', NULL, 'Grey', NULL, 0.0, 100, 'standby', 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(8, 1, 'G1', 'ENG123456', 'Updated Test Car', 'demo', '', 'Blue', NULL, 0.0, 100, 'standby', 0, '2025-12-23 11:25:13', '2025-12-23 11:31:46');
...
INSERT INTO `events` (`id`, `name`, `client_name`, `location`, `start_date`, `end_date`, `status`, `logo_url`, `theme_color`, `created_by`, `created_at`, `updated_at`, `is_deleted`) VALUES
(1, 'Tata Punch Launch', 'Tata Motors', 'Mumbai', '2025-12-20', '2025-12-25', 'completed', 'https://s7ap1.scene7.com/is/image/tatamotors/logo-new-black?$HL-50-33-D$&fit=fit&fmt=avif-alpha', '#080808', NULL, '2025-12-23 06:57:15', '2025-12-26 11:43:16', b'0');
...
--
-- Dumping data for table `event_promoters`
--

INSERT INTO `event_promoters` (`id`, `event_id`, `promoter_id`, `assigned_cars`, `created_at`, `is_deleted`) VALUES
(5, 1, 10, '1,2', '2025-12-23 13:21:45', 0),
(6, 1, 11, '3', '2025-12-23 13:21:45', 0),
(7, 1, 12, '5,4', '2025-12-23 13:21:45', 0),
(8, 1, 13, NULL, '2025-12-23 13:21:45', 0),
(9, 1, 6, '2', '2025-12-24 05:58:55', 0),
(10, 1, 14, '1,2', '2025-12-24 05:59:43', 0),
(11, 1, 7, NULL, '2025-12-24 06:08:31', 0);
...
(1, 1, 1, 'Ravi Auto Review', 'YouTube', '9800000001', NULL, '2025-12-23 06:57:15'),
(2, 1, 1, 'Neha Car Tips', 'Instagram', '9800000002', NULL, '2025-12-23 06:57:15'),
(3, 1, 2, 'AutoCar India', 'Magazine', '9800000003', NULL, '2025-12-23 06:57:15'),
(4, 1, 2, 'Car Dekho Team', 'Website', '9800000004', NULL, '2025-12-23 06:57:15'),
(5, 1, 3, 'MotorOctane', 'YouTube', '9800000005', NULL, '2025-12-23 06:57:15'),
(6, 1, 3, 'ZigWheels Reporter', 'Website', '9800000006', NULL, '2025-12-23 06:57:15');
...
(1, 1, 6, 1, '2025-12-23 06:57:15'),
(2, 1, 7, 2, '2025-12-23 06:57:15'),
(3, 1, 8, 3, '2025-12-23 06:57:15');
...
(1, 'MediaWorks PR', 'Rahul Sharma', '9876543210', 'rahul@mediaworks.com', 1, '2025-12-23 06:57:15'),
(2, 'AutoPR Agency', 'Priya Patel', '9876543211', 'priya@autopr.com', 1, '2025-12-23 06:57:15'),
(3, 'Velocity Communications', 'Amit Kumar', '9876543212', 'amit@velocity.com', 1, '2025-12-23 06:57:15');
...
(1, 1, 1, 1, '2025-12-23 06:57:15'),
(2, 1, 1, 2, '2025-12-23 06:57:15'),
(3, 1, 2, 3, '2025-12-23 06:57:15'),
(4, 1, 2, 4, '2025-12-23 06:57:15'),
(5, 1, 3, 5, '2025-12-23 06:57:15'),
(6, 1, 3, 6, '2025-12-23 06:57:15');
...
(1, 'Admin', 'admin@cloudplay.com', 'admin123', 'superadmin', NULL, NULL, 1, '2025-12-18 14:05:08', '2025-12-20 08:22:32'),
(5, 'Demo Client', 'client@demo.com', 'client123', 'client', NULL, NULL, 1, '2025-12-18 14:31:46', '2025-12-20 08:22:32'),
(6, 'Demo Promoter', 'promoter@demo.com', 'promoter123', 'promoter', '', NULL, 0, '2025-12-18 14:31:46', '2025-12-24 05:59:07'),
(7, 'John Promoter', 'john@demo.com', 'john123', 'promoter', '7449647543', NULL, 1, '2025-12-23 06:57:15', '2025-12-24 06:08:31'),
(8, 'Sarah Promoter', 'sarah@demo.com', 'sarah123', 'promoter', NULL, NULL, 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(9, 'Cleaning Staff', 'cleaning@demo.com', 'cleaning123', 'cleaning_staff', NULL, NULL, 1, '2025-12-23 06:57:15', '2025-12-23 06:57:15'),
(10, 'Rahul Sharma', 'rahul@example.com', 'promoter123', 'promoter', '+91 98765 00001', NULL, 1, '2025-12-23 13:17:59', '2025-12-23 13:17:59'),
(11, 'Priya Patel', 'priya@example.com', 'promoter123', 'promoter', '+91 98765 00002', NULL, 1, '2025-12-23 13:17:59', '2025-12-23 13:17:59'),
(12, 'Amit', 'amit@example.com', 'promoter123', 'promoter', '+91 98765 00003', NULL, 1, '2025-12-23 13:17:59', '2025-12-29 06:45:32'),
(13, 'Sneha Gupta', 'sneha@example.com', 'promoter123', 'promoter', '+91 98765 00004', NULL, 1, '2025-12-23 13:17:59', '2025-12-23 13:17:59'),
(14, 'John Smith', 'john@example.com', 'promoter123', 'promoter', '9876543210', NULL, 1, '2025-12-24 05:59:43', '2025-12-24 05:59:43');
